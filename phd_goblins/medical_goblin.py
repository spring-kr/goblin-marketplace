    ...
    def search_and_analyze(self, query):
        ...
        try:
            ...
            if found_terms:
                ...
                return f"""
🎓 **medical 도메인 박사급 전문 분석 - {info['full_name']}**

**분석 대상:** {query}

## ⚕️ **{info['full_name']} ({term.upper()}) 의학 전문가 분석**
...
**의학적 관점:**
- 근거 중심 의학(EBM) 기반 진단 및 치료
- 예방의학 접근법 및 건강증진 전략
- 환자 중심 치료 계획 및 개별화 의료
- 임상 가이드라인 준수 및 의료 안전성
- 다학제적 팀 접근 및 통합 의료 서비스

### 2. **실무 활용법 및 임상 적용**
{info['usage']}

**의료 서비스 제공 프로세스:**
- **병력 청취:** 체계적 문진 및 증상 평가
- **신체 진찰:** 전문적 검사 기법 및 소견 해석
- **진단 검사:** 적절한 검사 선택 및 결과 분석
- **치료 계획:** 개별화된 치료 전략 수립
- **추적 관찰:** 치료 효과 모니터링 및 조정

**고급 의료 기법:**
- **정밀의학:** 유전정보 기반 맞춤형 치료
- **텔레메디신:** 원격 진료 및 모니터링
- **AI 진단:** 인공지능 보조 진단 시스템
- **로봇 수술:** 최소 침습 수술 기법
- **재생의학:** 줄기세포 및 조직 공학 활용

### 3. **성과 기준 및 의료 품질 지표**
{info.get('benchmark', '의료 표준에 따라 평가 기준이 다름')}

**의료 품질 측정 체계:**
- **치료 성과:** 질병 완치율 및 증상 개선도
- **환자 안전:** 의료 사고 발생률 및 부작용 관리
- **환자 만족도:** 의료 서비스 만족도 및 신뢰도
- **접근성:** 의료 서비스 접근 용이성 및 대기 시간
- **비용 효과성:** 치료 비용 대비 효과 분석

### 4. **실전 예시 및 임상 사례**
{info.get('examples', '다양한 의료 상황에서 활용 가능')}

**진료과별 적용 사례:**
- **내과:** 만성질환 관리, 건강검진, 예방접종
- **외과:** 수술적 치료, 응급처치, 외상 관리
- **소아과:** 성장 발달 관리, 소아 질환 진료
- **정신과:** 정신건강 상담, 스트레스 관리, 심리치료
...
# MedicalGoblin Function Loader 클래스
class MedicalGoblin:
    def __init__(self):
...
def get_village_chief():
    ...
    if _village_chief_instance is None:
        _village_chief_instance = MedicalGoblin()
