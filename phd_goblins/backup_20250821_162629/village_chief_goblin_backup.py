...
# VillageChiefGoblin Function Loader 클래스
class VillageChiefGoblin:
    def __init__(self):
...
def get_village_chief():
    ...
    if _village_chief_instance is None:
        _village_chief_instance = VillageChiefGoblin()
