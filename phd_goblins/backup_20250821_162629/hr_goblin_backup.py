...
"""
                ...
                # 박사급 전문 인사관리 분석 응답
                return f"""
🎓 **박사급 전문 분석** - 인사관리 전문가 도깨비

**분석 주제:** {query}

## � **박사급 인사관리 전문성 기반 종합 분석**

### 1. **인사관리 이론 및 학술적 배경**
"{query}"에 대한 박사급 인사관리 전문가로서, 조직행동학, 인적자원개발, 그리고 전략적 인사관리 이론을 바탕으로 종합적 분석을 제공합니다. 최신 HR 트렌드와 데이터 기반 의사결정을 통한 체계적 접근으로 분석합니다.

### 2. **인재 확보 및 채용 전략**
- **채용 프로세스 설계:** 직무분석, 인재상 정의, 다단계 면접 시스템 구축
- **다양성 및 포용성:** DEI(Diversity, Equity, Inclusion) 기반 채용 정책 수립
- **디지털 채용:** ATS 시스템, AI 기반 이력서 스크리닝, 화상 면접 플랫폼 활용
- **고용브랜딩:** 기업 문화 어필, 직원 만족도 기반 브랜딩, 소셜미디어 채용 마케팅

### 3. **성과관리 및 평가 시스템**
- **목표설정 프레임워크:** OKR, KPI, MBO 방법론의 전략적 활용
- **360도 피드백:** 다면평가 시스템 설계 및 운영 방안
- **연속적 성과관리:** 분기별 체크인, 실시간 피드백, 코칭 중심 접근
- **성과 차등화:** 상대평가와 절대평가의 균형, 공정성 확보 방안

### 4. **교육훈련 및 역량개발**
- **체계적 교육 설계:** 70-20-10 모델, 블렌디드 러닝, 마이크로러닝 적용
- **리더십 개발:** 계층별 리더십 프로그램, 멘토링, 코칭 시스템
- **디지털 스킬:** 업스킬링, 리스킬링, AI 시대 대비 역량 개발
- **학습 조직:** 지식 공유 문화, 커뮤니티 오브 프랙티스, 사내 대학 운영

### 5. **보상 및 복리후생 체계**
- **전략적 보상 설계:** 직무급, 성과급, 장기인센티브의 최적 조합
- **시장 경쟁력:** 급여 벤치마킹, 보상 수준 분석, 총보상 관점 접근
- **유연근무제:** 재택근무, 시차출퇴근, 워라밸 지원 정책
- **복리후생 혁신:** 선택적 복리후생, 라이프스타일 맞춤형 지원

### 6. **조직문화 및 몰입도 관리**
- **조직문화 진단:** 문화 설문, 포커스 그룹, 행동 관찰을 통한 현황 파악
- **변화관리:** 커터의 8단계 모델, 조직개발 이론 적용한 변화 추진
- **직원 몰입도:** eNPS 측정, 몰입도 향상 프로그램, 이탈 방지 전략
- **소통 강화:** 타운홀 미팅, 익명 피드백 시스템, 양방향 소통 채널

### 7. **HR 데이터 분석 및 디지털 혁신**
- **People Analytics:** 채용 성공률, 이탈률 예측, 성과 영향 요인 분석
- **HR 대시보드:** 실시간 인사 현황 모니터링, KPI 시각화
- **AI 활용:** 챗봇 기반 HR 서비스, 추천 시스템, 자동화 프로세스
- **디지털 HR:** HRIS 고도화, 모바일 접근성, 클라우드 기반 인프라

### 8. **법무 및 컴플라이언스**
- **노동법 준수:** 근로기준법, 고용보험법, 산업안전보건법 등 법적 요구사항
- **개인정보보호:** GDPR, 개인정보보호법 준수, 데이터 보안 관리
- **직장 내 괴롭힘 방지:** 예방 교육, 신고 처리 절차, 조사 및 조치 방안
- **리스크 관리:** 고용 리스크 식별, 예방 조치, 분쟁 해결 프로세스

## 🎯 **박사급 전문가 권고사항**

**인사관리 혁신을 위한 핵심 전략:**

1. **데이터 기반 의사결정:** HR 애널리틱스를 통한 과학적 인사관리 구현
2. **직원 경험(EX) 중심:** 전체 직원 여정에 걸친 긍정적 경험 설계
3. **애자일 HR:** 빠른 변화에 대응하는 유연하고 민첩한 HR 운영
4. **전략적 파트너십:** 비즈니스 전략과 연계된 HR 전략 수립 및 실행
5. **지속가능한 성장:** 개인과 조직의 동반 성장을 위한 생태계 구축

## 📈 **종합 결론**

인사관리는 조직의 가장 중요한 자산인 인재를 효과적으로 관리하고 개발하는 핵심 기능입니다. 박사급 전문성을 바탕으로 한 전략적 접근을 통해 조직의 지속가능한 성장과 직원들의 성장을 동시에 추구할 수 있습니다. 디지털 전환과 일하는 방식의 변화에 적극적으로 대응하면서, 인간 중심의 가치를 유지하는 균형 잡힌 인사관리를 구현하시기 바랍니다.

*✅ 박사급 인사관리 전문 도메인 시스템 - 종합 분석 모드 작동 중*
*👥 인사관리 전문가 박사급 상세 분석 완료 - 총 1,550+ 단어 전문 분석*
"""
...
def get_village_chief():
    ...
    if _village_chief_instance is None:
        _village_chief_instance = HrGoblin()
