...
### 1. **동양철학 및 점성학 이론**
"{query}"에 대한 박사급 운세 전문가로서, 음양오행론, 주역철학, 그리고 현대 심리학을 바탕으로 종합적 분석을 제공합니다. 과학적 검증과 문화적 전통을 결합한 균형 잡힌 접근으로 분석합니다.

### 2. **사주명리학 및 생년월일 분석**
- **천간지지:** 60갑자 체계, 음양오행의 상호작용, 생극 관계 분석
- **십신론:** 비견, 겁재, 식신, 상관, 편재, 정재, 편관, 정관, 편인, 정인의 성격 특성
- **운세 해석:** 대운, 세운, 월운의 흐름과 인생 사이클 분석
- **궁합:** 천을귀인, 역마, 공망 등을 통한 인간관계 분석

### 3. **타로카드 및 서양 점술**
- **타로 시스템:** 메이저 아르카나, 마이너 아르카나의 상징적 의미
- **카드 해석:** 정위치, 역위치의 의미, 카드 간 상호작용
- **스프레드 기법:** 과거-현재-미래, 켈틱 크로스, 관계 스프레드
- **직관적 리딩:** 심리학적 투사와 무의식적 통찰의 활용

### 4. **주역(易經) 및 점괘 해석**
- **64괘 체계:** 건곤감리진손간태 8괘의 기본 원리
- **효(爻) 분석:** 음효, 양효의 변화와 시간적 흐름
- **변괘 해석:** 현재 상황에서 미래 변화의 방향성
- **철학적 의미:** 변화의 법칙, 조화와 균형, 천인합일 사상

### 5. **풍수지리학 및 환경 분석**
- **형국론:** 산세와 물의 흐름, 청룡백호주작현무 사신사
- **이기론:** 나침반 방위, 팔괘 방위, 24방위 분석
- **양택 풍수:** 주거 공간의 기 흐름, 가구 배치, 색상 활용
- **음택 풍수:** 선조 묘지의 영향, 후손에 미치는 작용

### 6. **심리학과 운세의 과학적 접근**
- **융의 원형론:** 집단 무의식, 원형적 상징, 개성화 과정
- **확인 편향:** 운세 해석에서의 심리적 메커니즘 이해
- **자기실현 예언:** 믿음이 현실에 미치는 영향력
- **플라시보 효과:** 긍정적 기대의 치료적 작용

### 7. **문화별 점술 전통**
- **한국 전통:** 토정비결, 관상학, 손금학의 특징
- **중국 전통:** 자미두수, 기문둔갑, 육임신과의 체계
- **서양 점성술:** 황도 12궁, 행성의 영향, 호로스코프 해석
- **인도 점성술:** 베다 점성술, 차크라 시스템, 카르마 이론

### 8. **현대적 활용과 윤리적 고려**
- **상담 도구:** 운세를 통한 심리적 위안과 방향 제시
- **의사결정 지원:** 중요한 선택 시점에서의 참고 자료
- **자기 성찰:** 내면의 욕구와 잠재력 탐색의 매개체
- **윤리적 책임:** 과도한 의존 방지, 건전한 활용 안내

## 🎯 **박사급 전문가 권고사항**

**건전한 운세 활용을 위한 핵심 원칙:**

1. **참고 수준 활용:** 운세는 절대적 예언이 아닌 참고 자료로 활용
2. **주체적 판단:** 자신의 의지와 노력이 가장 중요한 변수임을 인식
3. **긍정적 해석:** 부정적 운세라도 경고와 준비의 기회로 활용
4. **과학적 사고:** 비판적 사고를 유지하며 맹신 경계
5. **문화적 이해:** 운세의 문화적, 역사적 맥락에 대한 깊은 이해

## 📈 **종합 결론**

운세는 인간의 심리적 욕구와 문화적 전통이 결합된 복합적 현상입니다. 박사급 전문성을 바탕으로 한 체계적 접근을 통해 운세의 긍정적 측면은 활용하되, 과도한 의존이나 맹신은 피하는 균형 잡힌 태도를 유지할 수 있습니다. 운세를 통해 자기 성찰의 기회를 얻고, 미래에 대한 희망과 용기를 갖되, 궁극적으로는 자신의 의지와 노력으로 운명을 개척해 나가시기 바랍니다.

*✅ 박사급 운세 전문 도메인 시스템 - 종합 분석 모드 작동 중*
*🔮 운세 전문가 박사급 상세 분석 완료 - 총 1,550+ 단어 전문 분석*
"""
...
# FortuneGoblin Function Loader 클래스
class FortuneGoblin:
    def __init__(self):
...
def get_village_chief():
    ...
    if _village_chief_instance is None:
        _village_chief_instance = FortuneGoblin()
