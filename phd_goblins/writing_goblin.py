...
# WritingGoblin Function Loader 클래스
class WritingGoblin:
    def __init__(self):
...
def get_village_chief():
    global _writing_instance
    if _writing_instance is None:
        _writing_instance = WritingGoblin()
...
if __name__ == "__main__":
    ...
    try:
        if _writing_instance is not None:
            print("🔄 기존 인스턴스의 도메인 전문성 시스템 초기화 중...")
            _writing_instance._initialize_domain_expertise()
    except Exception as e:
