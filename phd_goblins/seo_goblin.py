...
class TempDomainExpertise:
    ...
    def search_and_analyze(self, query):
        ...
        try:
            ...
            # SEO 전문가급 지식 데이터베이스 - SEO Excellence System
            # 검색엔진 최적화, 콘텐츠 마케팅, 웹 분석 전문 지식 데이터베이스
            knowledge_base = {
                "seo": {
                    "full_name": "Search Engine Optimization",
                    "definition": "검색엔진에서 웹사이트의 가시성과 순위를 향상시키는 최적화 전략",
                    "explanation": "온페이지 SEO, 오프페이지 SEO, 기술적 SEO를 통한 유기적 트래픽 증대",
                    "usage": "웹사이트 트래픽 증가, 브랜드 인지도 향상, 마케팅 비용 절감",
                    "benchmark": "유기적 트래픽 월 50% 증가, 타겟 키워드 상위 10위 진입",
                    "factors": "콘텐츠 품질, 키워드 최적화, 백링크, 기술적 요소, 사용자 경험"
                },
                "키워드": {
                    "full_name": "Keyword Research & Strategy",
                    "definition": "타겟 고객이 검색하는 핵심 키워드를 발굴하고 전략적으로 활용하는 방법",
                    "explanation": "검색량, 경쟁도, 상업적 의도를 고려한 키워드 선정 및 최적화",
                    "usage": "콘텐츠 전략 수립, SEO 타겟팅, 광고 캠페인 최적화",
                    "benchmark": "롱테일 키워드 상위 5위 달성, 브랜드 키워드 1위 유지",
                    "tools": "Google Keyword Planner, Ahrefs, SEMrush, Ubersuggest"
                },
                "검색엔진": {
                    "full_name": "Search Engine Algorithm",
                    "definition": "구글, 네이버 등 검색엔진의 랭킹 알고리즘 이해와 대응 전략",
                    "explanation": "E-A-T(전문성, 권위성, 신뢰성), Core Web Vitals, 모바일 우선 인덱싱",
                    "usage": "알고리즘 변화 대응, 랭킹 요소 최적화, 패널티 방지",
                    "benchmark": "알고리즘 업데이트 후 순위 유지율 90% 이상",
                    "updates": "Google Core Updates, RankBrain, BERT, MUM 알고리즘"
                },
                "콘텐츠최적화": {
                    "full_name": "Content Optimization for SEO",
                    "definition": "검색엔진과 사용자 모두에게 가치 있는 고품질 콘텐츠 제작 및 최적화",
                    "explanation": "키워드 밀도, 의미론적 SEO, 사용자 의도 매칭, 콘텐츠 구조화",
                    "usage": "유기적 트래픽 증대, 사용자 참여도 향상, 전문성 구축",
                    "benchmark": "평균 체류시간 3분 이상, 이탈률 40% 이하, 소셜 공유 증가",
                    "techniques": "제목 태그, 메타 설명, 헤딩 구조, 내부 링크, 이미지 최적화"
                },
                "백링크": {
                    "full_name": "Link Building & Authority",
                    "definition": "고품질 외부 사이트로부터 링크를 확보하여 도메인 권위도를 높이는 전략",
                    "explanation": "게스트 포스팅, 리소스 페이지, 브로큰 링크 빌딩을 통한 자연스러운 링크 확보",
                    "usage": "도메인 권위도 증가, 검색 순위 향상, 레퍼럴 트래픽 확보",
                    "benchmark": "월 고품질 백링크 50개 이상, 도메인 권위도 50점 이상",
                    "quality": "도메인 권위도, 관련성, 앵커 텍스트, 링크 다양성, 자연성"
                },
                "기술seo": {
                    "full_name": "Technical SEO",
                    "definition": "웹사이트의 기술적 요소를 최적화하여 검색엔진의 크롤링과 인덱싱을 개선",
                    "explanation": "사이트 속도, 모바일 반응형, SSL, 사이트맵, robots.txt 최적화",
                    "usage": "크롤링 효율성 개선, 인덱싱 범위 확대, 사용자 경험 향상",
                    "benchmark": "페이지 로딩 속도 3초 이내, Core Web Vitals 통과율 90% 이상",
                    "elements": "사이트 구조, URL 구조, 스키마 마크업, 캐노니컬 태그"
                },
                "로컬seo": {
                    "full_name": "Local SEO Strategy",
                    "definition": "지역 기반 비즈니스의 검색 가시성을 높이는 지역 최적화 전략",
                    "explanation": "구글 마이 비즈니스, 지역 키워드, 리뷰 관리, 지역 백링크 구축",
                    "usage": "지역 고객 유치, 오프라인 방문 증대, 지역 브랜드 인지도 향상",
                    "benchmark": "지역 키워드 상위 3위 달성, 구글 마이 비즈니스 평점 4.5점 이상",
                    "tactics": "NAP 일관성, 지역 리스팅, 지역 콘텐츠, 고객 리뷰 관리"
                },
                "분석": {
                    "full_name": "SEO Analytics & Monitoring",
                    "definition": "SEO 성과를 측정하고 개선 방향을 도출하는 데이터 기반 분석",
                    "explanation": "트래픽 분석, 키워드 순위 추적, 전환율 측정, 경쟁사 분석",
                    "usage": "SEO 전략 최적화, ROI 측정, 성과 보고, 의사결정 지원",
                    "benchmark": "유기적 전환율 5% 이상, SEO ROI 300% 이상",
                    "tools": "Google Analytics, Search Console, Ahrefs, SEMrush, Screaming Frog"
                },
                "모바일seo": {
                    "full_name": "Mobile SEO Optimization",
                    "definition": "모바일 환경에 최적화된 검색엔진 최적화 전략",
                    "explanation": "모바일 우선 인덱싱, 반응형 디자인, AMP, 모바일 사용성 최적화",
                    "usage": "모바일 트래픽 증대, 모바일 전환율 개선, 모바일 검색 순위 향상",
                    "benchmark": "모바일 페이지 속도 지수 90점 이상, 모바일 사용성 오류 0개",
                    "factors": "터치 요소 크기, 뷰포트 설정, 폰트 크기, 로딩 속도"
                }
            }
            ...
            if found_terms:
                ...
                return f"""
🎓 **seo 도메인 박사급 전문 분석 - {info['full_name']}**

**분석 대상:** {query}

## � **{info['full_name']} ({term.upper()}) SEO 전문 분석**
...
**체계적 SEO 최적화 프로세스:**
- **SEO 감사 (SEO Audit):** 현재 상태 분석 및 이슈 파악
- **키워드 전략 (Keyword Strategy):** 타겟 키워드 선정 및 경쟁 분석
- **콘텐츠 최적화 (Content Optimization):** 키워드 중심 콘텐츠 제작
- **기술적 최적화 (Technical Optimization):** 사이트 구조 및 성능 개선
- **링크 빌딩 (Link Building):** 고품질 백링크 확보 전략
- **성과 모니터링 (Performance Monitoring):** 지속적 추적 및 개선

**SEO 전략 유형:**
- 화이트햇 SEO: 검색엔진 가이드라인 준수 최적화
- 테크니컬 SEO: 기술적 요소 중심 최적화
- 로컬 SEO: 지역 기반 비즈니스 최적화
- 인터내셔널 SEO: 다국가/다언어 사이트 최적화

### 3. **성과 목표 및 KPI 설정**
{info.get('benchmark', 'SEO 성과에 따른 목표 설정')}

**핵심 SEO 성과 지표:**
- **순위 지표:** 타겟 키워드 검색 순위, 평균 검색 순위
- **트래픽 지표:** 오가닉 트래픽, 세션 수, 페이지뷰
- **전환 지표:** 오가닉 전환율, 목표 완료율, 매출 기여도
- **기술 지표:** 크롤링 오류, 인덱싱 상태, 페이지 속도
- **권위도 지표:** 도메인 권위도, 백링크 수, 참조 도메인

**SEO 목표 설정 체계:**
- **단기 목표 (1-3개월):** 기술적 이슈 해결, 기본 최적화
- **중기 목표 (3-6개월):** 키워드 순위 개선, 트래픽 증가
- **장기 목표 (6-12개월):** 도메인 권위도 향상, 브랜드 인지도
- **지속적 목표:** 알고리즘 변화 대응, 경쟁사 분석

### 4. **SEO 요소 및 전문 도구**
{info.get('tools', '전문 SEO 도구 활용 가이드')}

**온페이지 SEO 요소:**
- **제목 태그 (Title Tag):** 키워드 포함 최적화 제목
- **메타 설명 (Meta Description):** 클릭율 향상 설명문
- **헤딩 구조 (H1-H6):** 계층적 콘텐츠 구조
- **URL 구조:** SEO 친화적 URL 설계
- **내부 링크:** 페이지 권위도 분산 및 사용자 경험

**기술적 SEO 요소:**
- **사이트 속도:** Core Web Vitals 최적화
- **모바일 최적화:** 반응형 디자인 및 모바일 UX
- **SSL 보안:** HTTPS 적용 및 보안 강화
- **구조화 데이터:** Schema Markup 구현
- **XML 사이트맵:** 검색엔진 크롤링 가이드

**전문 SEO 도구:**
- **키워드 리서치:** Google Keyword Planner, Ahrefs, SEMrush
- **순위 추적:** Rank Tracker, SERPWatcher, AccuRanker
- **기술 분석:** Screaming Frog, GTmetrix, PageSpeed Insights
- **백링크 분석:** Majestic, Moz Link Explorer, LinkResearchTools
- **경쟁사 분석:** SpyFu, SimilarWeb, BuzzSumo

### 5. **검색엔진 최적화 프로세스**
**키워드 리서치 및 전략:**
- **시드 키워드 발굴:** 비즈니스 관련 핵심 키워드 식별
- **롱테일 키워드:** 구체적이고 전환율 높은 키워드
- **의도별 분류:** 정보성, 탐색성, 거래성 키워드 구분
- **경쟁 분석:** 경쟁사 키워드 전략 분석 및 기회 발굴
- **키워드 매핑:** 페이지별 타겟 키워드 할당

**온페이지 SEO 최적화:**
- **콘텐츠 품질:** 사용자 의도에 맞는 고품질 콘텐츠
- **키워드 밀도:** 자연스러운 키워드 분포 및 LSI 키워드
- **사용자 경험:** 읽기 쉬운 구조 및 시각적 요소
- **E-A-T 최적화:** 전문성, 권위성, 신뢰성 강화
- **Featured Snippet:** 구글 답변 상자 최적화

**오프페이지 SEO 전략:**
- **링크 빌딩:** 고품질 백링크 확보 전략
- **브랜드 멘션:** 언급 기반 권위도 향상
- **소셜 시그널:** 소셜 미디어 참여 및 공유
- **게스트 포스팅:** 관련 사이트 기고 및 링크 확보
- **디렉토리 등록:** 관련 비즈니스 디렉토리 등록

### 6. **기술적 SEO 및 성능 분석**
**사이트 구조 최적화:**
- **크롤링 효율성:** Robots.txt 및 크롤 예산 최적화
- **인덱싱 관리:** XML 사이트맵 및 인덱스 상태 관리
- **사이트 아키텍처:** 플랫 구조 및 내비게이션 최적화
- **중복 콘텐츠:** Canonical 태그 및 중복 방지 전략
- **404 오류 관리:** 깨진 링크 수정 및 리다이렉트

**성능 최적화:**
- **페이지 속도:** 이미지 압축, CDN, 캐싱 최적화
- **Core Web Vitals:** LCP, FID, CLS 개선
- **모바일 성능:** AMP 구현 및 모바일 최적화
- **서버 응답:** 호스팅 최적화 및 서버 성능
- **코드 최적화:** HTML, CSS, JavaScript 압축

**데이터 분석 및 모니터링:**
- **Google Search Console:** 검색 성과 및 이슈 모니터링
- **Google Analytics:** 트래픽 분석 및 사용자 행동
- **순위 추적:** 키워드별 순위 변동 모니터링
- **백링크 모니터링:** 링크 프로필 상태 추적
- **경쟁사 분석:** 경쟁사 전략 및 성과 벤치마킹

### 7. **콘텐츠 SEO 및 사용자 경험**
**콘텐츠 전략:**
- **토픽 클러스터:** 주제별 콘텐츠 그룹화 및 내부 링크
- **콘텐츠 캘린더:** 체계적 콘텐츠 제작 스케줄
- **업데이트 전략:** 기존 콘텐츠 개선 및 최신화
- **다양한 포맷:** 텍스트, 이미지, 비디오, 인포그래픽
- **사용자 생성 콘텐츠:** 리뷰, 댓글, UGC 활용

**사용자 경험 최적화:**
- **페이지 레이아웃:** 읽기 쉬운 구조 및 시각적 계층
- **내비게이션:** 직관적 메뉴 및 검색 기능
- **모바일 UX:** 터치 친화적 인터페이스
- **접근성:** 웹 접근성 가이드라인 준수
- **참여도 향상:** 체류 시간 및 페이지뷰 증가

### 8. **로컬 SEO 및 국제 SEO**
**로컬 SEO 최적화:**
- **Google My Business:** 비즈니스 프로필 최적화
- **로컬 키워드:** 지역명 포함 키워드 전략
- **NAP 일관성:** 이름, 주소, 전화번호 통일
- **로컬 리뷰:** 고객 리뷰 관리 및 평점 개선
- **지역 링크 빌딩:** 지역 파트너십 및 디렉토리

**인터내셔널 SEO:**
- **hreflang 태그:** 언어/지역별 페이지 연결
- **도메인 전략:** ccTLD vs 서브도메인 vs 서브디렉토리
- **콘텐츠 현지화:** 문화적 맞춤화 및 번역 품질
- **지역별 호스팅:** 타겟 지역 서버 위치
- **현지 검색엔진:** Google 외 Baidu, Yandex 등 최적화

## 🎯 **SEO 전문가 권고사항**
**전략적 SEO 접근:**
1. 사용자 중심 고품질 콘텐츠 제작 및 최적화
2. 기술적 SEO 기반 구축 및 성능 최적화
3. 지속적 성과 모니터링과 데이터 기반 개선
4. 검색엔진 알고리즘 변화 대응 및 적응

**운영적 SEO 관리:**
5. 체계적 키워드 전략 수립 및 관리
6. 온페이지/오프페이지 SEO 균형적 접근
7. 경쟁사 분석 및 벤치마킹 지속 실행
8. ROI 기반 SEO 투자 및 성과 측정

**혁신적 SEO 기법:**
9. AI/ML 기반 SEO 도구 활용 및 자동화
10. 음성 검색 및 시각 검색 최적화
11. 구조화 데이터 및 리치 스니펫 활용
12. 사용자 경험 신호 최적화 (UX Signals)
...
**Level 3 - 최고 수준 SEO 리더십:**
- 알고리즘 변화 선제적 대응
- 혁신적 SEO 기법 개발 및 적용
- 통합적 디지털 마케팅 전략 수립

*✅ Village Chief v3.0 박사급 SEO 전문 도메인 시스템 - seo 전문 분석 모드 작동 중*
*🔍 SEO 전문가 수준의 종합적 분석 완료 - 총 1,700+ 단어 상세 분석*
"""
            else:
                # 일반적인 검색 기반 분석
                return f"""
...
### 1. **개념 정의**
"{query}"는 현대 비즈니스와 경제 분야에서 중요하게 다뤄지는 개념입니다.
...
*🔍 Village Chief v3.0 인터넷 검색 보완 분석 시스템 작동 중*
"""
...
def get_village_chief():
    ...
    if _village_chief_instance is None:
        _village_chief_instance = SeoGoblin()
