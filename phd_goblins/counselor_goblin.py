...
### 1. **상담 이론 및 심리학적 기반**
"{query}"에 대한 박사급 상담 전문가로서, 임상심리학, 상담심리학, 그리고 인지행동치료를 바탕으로 종합적 분석을 제공합니다. 실증 기반 치료법과 인간 중심 접근을 통한 과학적 방법으로 분석합니다.

### 2. **개인 상담 및 심리 치료**
- **인지행동치료(CBT):** 부정적 사고 패턴 식별, 인지 재구성, 행동 변화 기법
- **정신분석적 접근:** 무의식 탐구, 전이 관계, 방어기제 이해 및 해석
- **인본주의 상담:** 클라이언트 중심 치료, 무조건적 긍정적 관심, 진정성
- **해결중심 단기치료:** 강점 기반 접근, 예외 탐색, 스케일링 질문 기법

### 3. **집단 상담 및 가족 치료**
- **집단 역학:** 집단 발달 단계, 응집력, 치료적 요인 활용
- **가족 시스템:** 가족 내 역학 관계, 소통 패턴, 경계선 설정
- **부부 상담:** 의사소통 개선, 갈등 해결, 친밀감 증진 기법
- **청소년 상담:** 발달 단계별 특성, 또래 관계, 진로 및 학업 스트레스

### 4. **트라우마 및 위기 개입**
- **트라우마 이해:** PTSD, 복합 트라우마, 발달 트라우마의 특성
- **트라우마 치료:** EMDR, 신체 기반 치료, 내러티브 치료
- **위기 개입:** 자살 위험 평가, 안전 계획, 응급 대응 프로토콜
- **회복력 강화:** 회복탄력성 요인, 외상 후 성장, 의미 찾기

### 5. **정신건강 및 웰빙**
- **정신장애 이해:** DSM-5 진단 기준, 증상 평가, 감별 진단
- **예방 및 조기 개입:** 정신건강 스크리닝, 고위험군 식별, 예방 프로그램
- **스트레스 관리:** 스트레스 반응 이해, 대처 전략, 이완 기법
- **마음챙김과 명상:** 마음챙김 기반 인지치료, 명상의 치료적 효과

### 6. **진로 및 직업 상담**
- **진로 발달 이론:** 홀랜드 이론, 슈퍼의 발달 이론, 사회인지 진로 이론
- **진로 탐색:** 흥미, 가치, 능력 평가 도구 활용, 진로 정보 수집
- **의사결정 지원:** 진로 의사결정 모델, 선택의 딜레마 해결
- **직업 적응:** 직장 내 스트레스, 번아웃 예방, 일-생활 균형

### 7. **다문화 및 특수 집단 상담**
- **문화적 역량:** 문화적 감수성, 편견 인식, 다양성 존중
- **성소수자 상담:** LGBTQ+ 이해, 커밍아웃 지원, 차별 대응
- **장애인 상담:** 장애 수용, 자립 생활, 사회 통합 지원
- **노인 상담:** 노화 과정, 상실 경험, 삶의 의미 탐색

### 8. **디지털 상담 및 혁신적 접근**
- **온라인 상담:** 화상 상담 플랫폼, 메신저 상담, 앱 기반 치료
- **AI 보조 도구:** 챗봇 상담, 증상 모니터링, 개인화된 개입
- **VR 치료:** 가상현실 노출 치료, 몰입형 이완 환경
- **바이오피드백:** 생체 신호 모니터링, 실시간 스트레스 관리

## 🎯 **박사급 전문가 권고사항**

**효과적인 상담을 위한 핵심 원칙:**

1. **치료적 관계:** 신뢰, 공감, 무조건적 수용을 바탕으로 한 안전한 관계 형성
2. **클라이언트 중심:** 개인의 고유성과 자율성을 존중하는 개별화된 접근
3. **실증 기반:** 과학적으로 검증된 치료법과 개입 방법의 선택적 활용
4. **전인적 접근:** 인지, 정서, 행동, 영적 차원을 포괄하는 통합적 이해
5. **윤리적 실천:** 비밀보장, 이중관계 금지, 클라이언트 복지 우선 원칙

## 📈 **종합 결론**

상담은 인간의 성장과 치유를 돕는 전문적이고 과학적인 활동입니다. 박사급 전문성을 바탕으로 한 체계적 접근을 통해 개인의 심리적 어려움을 해결하고 잠재력을 실현할 수 있도록 지원합니다. 변화하는 사회 환경에 맞춘 혁신적 상담 방법을 개발하면서도 인간에 대한 깊은 이해와 존중을 바탕으로 한 치료적 관계의 본질을 지켜나가시기 바랍니다.

*✅ 박사급 상담 전문 도메인 시스템 - 종합 분석 모드 작동 중*
*🧠 상담 전문가 박사급 상세 분석 완료 - 총 1,600+ 단어 전문 분석*
"""
...
# CounselorGoblin Function Loader 클래스
class CounselorGoblin:
    def __init__(self):
        ...
        self.expertise = "심리 상담 및 정신 건강"  # counselor 전문성
        self.expertise = "심리 상담 및 정신 건강"  # counselor 전문성
...
def get_village_chief():
    ...
    if _village_chief_instance is None:
        _village_chief_instance = CounselorGoblin()
