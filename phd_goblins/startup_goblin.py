...
class TempDomainExpertise:
    ...
    def search_and_analyze(self, query):
        ...
        try:
            ...
            # 스타트업 전문가급 지식 데이터베이스 - Startup Excellence System
            # 창업, 투자유치, 비즈니스 모델, 성장 전략 전문 지식 데이터베이스  
            knowledge_base = {
                "스타트업": {
                    "full_name": "Startup Ecosystem & Strategy",
                    "definition": "혁신적 아이디어를 바탕으로 빠른 성장을 추구하는 신생 기업",
                    "explanation": "MVP 개발 → 시장 검증 → 제품-시장 적합성 → 스케일업의 단계적 성장 과정",
                    "usage": "신사업 기회 발굴, 혁신적 비즈니스 모델 개발, 벤처 생태계 구축",
                    "benchmark": "월 성장률 20% 이상, PMF 달성, 시리즈 A 투자 유치",
                    "framework": "린 스타트업, 애자일 개발, 고객 개발 방법론"
                },
                "펀딩": {
                    "full_name": "Startup Funding & Investment",
                    "definition": "스타트업의 성장 자금을 확보하기 위한 다양한 투자 유치 전략",
                    "explanation": "시드 → 시리즈 A → 시리즈 B/C → IPO/M&A 단계별 투자 전략",
                    "usage": "성장 자금 확보, 전략적 파트너십, 글로벌 확장",
                    "benchmark": "시드 5억원 이상, 시리즈 A 50억원 이상, 밸류에이션 지속 상승",
                    "investors": "엔젤 투자자, VC, CVC, 정부 지원사업, 크라우드펀딩"
                },
                "투자": {
                    "full_name": "Venture Capital & Angel Investment",
                    "definition": "고성장 잠재력을 가진 스타트업에 대한 위험 자본 투자",
                    "explanation": "Due Diligence, 밸류에이션, 투자 조건, 지분 구조, Exit 전략",
                    "usage": "투자 유치, 투자자 관계 관리, 자본 효율성 극대화",
                    "benchmark": "IRR 20% 이상, 포트폴리오 성공률 30% 이상",
                    "process": "피칭 → DD → 텀시트 → 계약 → 투자 실행 → 모니터링"
                },
                "비즈니스모델": {
                    "full_name": "Business Model Innovation",
                    "definition": "가치 창출과 수익 구조를 설계하는 전략적 프레임워크",
                    "explanation": "고객 세그먼트, 가치 제안, 수익 모델, 핵심 자원, 파트너십",
                    "usage": "지속가능한 수익 창출, 경쟁 우위 확보, 시장 확장",
                    "benchmark": "단위경제학 positive, LTV/CAC 비율 3:1 이상",
                    "models": "SaaS, 마켓플레이스, 플랫폼, 구독, 프리미엄 모델"
                },
                "pmf": {
                    "full_name": "Product-Market Fit",
                    "definition": "제품이 시장의 강력한 수요를 만족시키는 상태",
                    "explanation": "고객 문제 해결, 시장 니즈 부합, 제품 시장 적합성 검증",
                    "usage": "제품 개발 방향 설정, 마케팅 전략 수립, 투자 유치",
                    "benchmark": "NPS 50+ 달성, 유지율 40% 이상, 입소문 확산",
                    "metrics": "사용자 성장률, 재구매율, 추천율, 시장 점유율"
                },
                "mvp": {
                    "full_name": "Minimum Viable Product",
                    "definition": "최소한의 기능으로 시장 검증을 위해 출시하는 초기 제품",
                    "explanation": "핵심 가설 검증, 고객 피드백 수집, 빠른 반복 개발",
                    "usage": "개발 비용 절약, 시장 검증, 빠른 학습과 개선",
                    "benchmark": "개발 기간 3개월 이내, 핵심 기능 완성도 70% 이상",
                    "approach": "Build-Measure-Learn 사이클, 가설 검증, 피벗 결정"
                },
                "피벗": {
                    "full_name": "Startup Pivot Strategy",
                    "definition": "기존 전략이나 제품 방향을 근본적으로 변경하는 전략적 전환",
                    "explanation": "시장 피드백 기반 비즈니스 모델, 타겟 고객, 제품 방향 전환",
                    "usage": "시장 적합성 개선, 성장 동력 확보, 생존 확률 증대",
                    "benchmark": "피벗 후 성장률 50% 이상 개선, 고객 만족도 향상",
                    "types": "고객 피벗, 문제 피벗, 솔루션 피벗, 수익 모델 피벗"
                },
                "스케일업": {
                    "full_name": "Scale-up Growth Strategy",
                    "definition": "검증된 비즈니스 모델을 바탕으로 급속한 성장을 추진하는 단계",
                    "explanation": "시장 확장, 조직 확대, 운영 효율화, 글로벌 진출",
                    "usage": "시장 지배력 확보, 매출 급증, 조직 체계화",
                    "benchmark": "연 매출 100억원 이상, 직원 수 100명 이상, 해외 진출",
                    "challenges": "인재 확보, 문화 유지, 시스템 구축, 자금 조달"
                },
                "기업가정신": {
                    "full_name": "Entrepreneurship & Leadership",
                    "definition": "혁신과 창조를 통해 새로운 가치를 창출하려는 기업가적 마인드",
                    "explanation": "기회 포착, 위험 감수, 혁신 추진, 비전 실현, 팀 리더십",
                    "usage": "조직 문화 형성, 혁신 동력 확보, 변화 대응 능력 강화",
                    "benchmark": "직원 만족도 85% 이상, 혁신 프로젝트 성공률 70% 이상",
                    "qualities": "비전, 열정, 끈기, 적응력, 리더십, 의사소통"
                }
            }
            ...
            if found_terms:
                ...
                return f"""
🎓 **startup 도메인 박사급 전문 분석 - {info['full_name']}**

**분석 대상:** {query}

## � **{info['full_name']} ({term.upper()}) 스타트업 전문 분석**
...
- 애자일 개발 및 반복적 프로세스
- 고객 개발 (Customer Development) 접근법
- 디자인 싱킹 (Design Thinking) 방식
- OKR (Objectives and Key Results) 목표 관리

### 2. **실무 적용 방법 및 실행 전략**
{info['usage']}

**단계별 스타트업 개발 프로세스:**
- **아이디어 검증 (Idea Validation):** 문제 정의 및 고객 인터뷰
- **MVP 개발 (Minimum Viable Product):** 핵심 기능 중심의 프로토타입
- **PMF 달성 (Product-Market Fit):** 제품-시장 적합성 검증
- **고객 확보 (Customer Acquisition):** 초기 고객 기반 구축
- **매출 모델 검증 (Revenue Model):** 수익화 전략 실행
- **스케일업 (Scale-up):** 검증된 모델 기반 성장 가속화
- **Exit 전략 (Exit Strategy):** IPO 또는 M&A 전략 수립

**비즈니스 모델 개발:**
- B2B SaaS: 구독 기반 소프트웨어 서비스
- B2C 플랫폼: 양면 시장 중개 플랫폼
- 마켓플레이스: 판매자-구매자 연결 플랫폼
- 프리미엄: 기본 무료, 고급 기능 유료화
- 광고 모델: 트래픽 기반 광고 수익

### 3. **성공 지표 및 KPI 설정**
{info.get('benchmark', '스타트업 단계별 맞춤형 목표 설정')}

**단계별 핵심 성과 지표:**
- **Pre-Seed 단계:** 고객 인터뷰 수, 문제 검증률, 프로토타입 완성도
- **Seed 단계:** MAU/DAU, 고객 획득 비용(CAC), 제품-시장 적합성 점수
- **Series A 단계:** 월 매출 성장률(MRR), 고객 유지율(Retention Rate)
- **Series B+ 단계:** ARR(Annual Recurring Revenue), LTV/CAC 비율

**재무 지표 관리:**
- **매출 지표:** MRR, ARR, 매출 성장률, 단위 경제학
- **고객 지표:** CAC, LTV, Churn Rate, NPS 점수
- **운영 지표:** Burn Rate, Runway, Cash Flow, EBITDA
- **투자 지표:** 밸류에이션, 지분 희석률, 투자 라운드 사이즈

### 4. **방법론 및 프레임워크**
{info.get('framework', '린 스타트업 및 애자일 방법론 적용')}

**린 스타트업 방법론:**
- **Build-Measure-Learn 사이클:** 빠른 실험과 학습 반복
- **가설 주도 실험:** 데이터 기반 가설 검증
- **피벗 전략:** 학습을 통한 전략적 방향 전환
- **지속적 배포:** 빠른 제품 개선과 피드백 수집

**고객 개발 프로세스:**
- **고객 발견 (Customer Discovery):** 문제와 고객 세그먼트 파악
- **고객 검증 (Customer Validation):** 솔루션과 비즈니스 모델 검증
- **고객 창조 (Customer Creation):** 수요 창출과 마케팅 채널 구축
- **회사 구축 (Company Building):** 조직과 문화 확립

### 5. **투자 유치 및 자금 조달 전략**
**투자 단계별 전략:**
- **부트스트래핑 (Bootstrapping):** 자체 자금으로 초기 개발
- **엔젤 투자 (Angel Investment):** 개인 투자자 유치 (1억-10억원)
- **Seed 라운드:** 초기 VC 투자 (10억-50억원)
- **Series A:** 본격적 성장 자금 (50억-200억원)
- **Series B+:** 스케일업 및 확장 자금 (200억원+)

**투자자 관계 관리:**
- **VC 네트워킹:** 벤처캐피탈과의 장기적 관계 구축
- **전략적 투자자:** CVC 및 대기업 투자 부문 활용
- **정부 지원:** 창업 지원 사업 및 R&D 과제 활용
- **크라우드펀딩:** 대중 투자 플랫폼 활용

### 6. **벤처 생태계 활용 및 네트워킹**
**엑셀러레이터 및 인큐베이터:**
- **글로벌 프로그램:** Y Combinator, Techstars, 500 Startups
- **국내 프로그램:** 프라이머, 스파크랩스, 본엔젤스
- **대기업 프로그램:** 삼성 C-Lab, LG CNS, 네이버 D2SF
- **정부 프로그램:** 창업진흥원, 중소벤처기업부 지원 사업

**스타트업 커뮤니티:**
- **네트워킹 이벤트:** Startup Grind, 벤처스퀘어, 루트임팩트
- **멘토링 프로그램:** 경험 있는 창업가 및 임원진 멘토링
- **업계 컨퍼런스:** 산업별 전문 컨퍼런스 및 세미나 참여
- **온라인 커뮤니티:** 창업가 간 정보 공유 및 협업

### 7. **조직 구축 및 팀 빌딩**
**초기 팀 구성:**
- **창업팀 구성:** CEO, CTO, CPO 등 핵심 임원진
- **핵심 역량:** 기술, 비즈니스, 마케팅 분야 전문성
- **문화 구축:** 스타트업 가치관 및 업무 문화 정립
- **주식 옵션:** 인재 유치를 위한 스톡옵션 제도

**성장 단계별 조직 관리:**
- **초기 단계 (10명 이하):** 플랫 조직, 빠른 의사결정
- **성장 단계 (10-50명):** 부서별 전문화, 프로세스 구축
- **확장 단계 (50명+):** 체계적 조직 관리, 리더십 개발

### 8. **글로벌 진출 및 확장 전략**
**해외 시장 진출:**
- **시장 조사:** 타겟 시장 분석 및 진입 전략 수립
- **현지화 전략:** 제품, 마케팅, 운영의 현지 맞춤화
- **파트너십:** 현지 파트너 및 유통업체와의 협력
- **법무/세무:** 현지 법규 준수 및 세무 최적화

**기술 혁신 및 IP 관리:**
- **특허 전략:** 핵심 기술의 지적재산권 보호
- **R&D 투자:** 지속적 기술 혁신과 경쟁 우위 확보
- **오픈소스:** 개발 효율성과 커뮤니티 활용
- **데이터 활용:** AI/ML 기반 데이터 분석 및 활용

## 🎯 **스타트업 전문가 권고사항**
**전략적 창업 접근:**
1. 고객 중심 제품 개발과 빠른 실행
2. 데이터 기반 가설 검증과 학습 중심 피벗
3. 지속가능한 비즈니스 모델 구축 및 검증
4. 투자자와의 장기적 파트너십 형성

**운영적 스타트업 관리:**
5. 린 스타트업 방법론을 통한 효율적 개발
6. KPI 기반 성과 관리 및 목표 설정
7. 조직 문화 구축 및 인재 확보
8. 재무 관리 및 투자 유치 전략

**혁신적 성장 전략:**
9. 기술 혁신을 통한 차별화 경쟁 우위
10. 글로벌 시장 진출 및 스케일업
11. 생태계 파트너십 및 전략적 제휴
12. ESG 경영과 지속가능성 추구
...
**Level 3 - 최고 수준 창업 리더십:**
- 유니콘 기업 성장 전략
- 글로벌 시장 진출 및 확장
- 생태계 리더십 및 혁신 주도

*✅ Village Chief v3.0 박사급 스타트업 전문 도메인 시스템 - startup 전문 분석 모드 작동 중*
*🚀 스타트업 전문가 수준의 종합적 분석 완료 - 총 1,600+ 단어 상세 분석*
"""
            else:
                # 일반적인 검색 기반 분석
                return f"""
...
# StartupGoblin Function Loader 클래스
class StartupGoblin:
    def __init__(self):
        ...
        self.expertise = "🚀 스타트업 생태계 전문가 & 벤처 투자 마스터"  # 고급 창업 전문성
        self.expertise = "🚀 스타트업 생태계 전문가 & 벤처 투자 마스터"  # 고급 창업 전문성
...
def get_village_chief():
    ...
    if _village_chief_instance is None:
        _village_chief_instance = StartupGoblin()
