...
class STEMService:
    ...
    def _generate_smart_response(self, question: str, agent_type: str, info: dict) -> str:
        """스마트 AI 답변 생성"""
...
def add_stem_routes(app: FastAPI):
    ...
    async def stem_ask(request: STEMRequest):
        """STEM 질문 처리 API"""
        try:
            result = await stem_service.process_question(request.question, request.agent_type)
